...
ods rtf FILE='H:\SAS\output\execsum_Catherine.rtf' bodytitle startpage=no KEEPN;	


/*********** Do NOT change code below! (unless you know what you are doing.) :) ***************/

DATA Ddatasas.ExecSum;
	SET Ddatasas.SASMaster(keep= LoanProgram OrigTerm CurWac cCurBal PremDiscAmt curIncentive curInc );
