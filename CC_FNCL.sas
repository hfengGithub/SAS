...
/* -------------------------------------------------------------------
   Data set sasuser.impw does not need to be sorted.
   ------------------------------------------------------------------- */
...
PROC REG DATA=WORK.SORTTempTableSorted
	;
	Linear_Regression_Model: MODEL FNCL = USSW2 USSW5 USSW10
		/		SELECTION=NONE
		INCLUDE=0
...
/* End of custom user code. */
	...
	OUTPUT OUT=SASUSER.PREDLinRegPredictions_7YRCHG__95(LABEL="Linear regression predictions and statistics for sasuser.impw")
		PREDICTED=predicted_FNCL ;
RUN;
QUIT;
...
/* ********* PREDICTED plots ********* */
	...
	TITLE4 "Observed FNCL by Predicted FNCL";
	SYMBOL1 C=BLUE V=DOT HEIGHT=2PCT INTERPOL=NONE L=1 W=1;
	LABEL _predicted1 = "Predicted FNCL";
	WHERE FNCL IS NOT MISSING AND _predicted1 IS NOT MISSING;
	PLOT FNCL * _predicted1 /
		VAXIS=AXIS1 VMINOR=0 HAXIS=AXIS3 HMINOR=0
		DESCRIPTION = "Observed FNCL by Predicted FNCL"
	;
	RUN;

	TITLE4 "Observed FNCL by USSW2";
	SYMBOL1 C=BLUE V=DOT HEIGHT=2PCT INTERPOL=RL L=1 W=1;
	WHERE FNCL IS NOT MISSING AND USSW2 IS NOT MISSING;
	PLOT FNCL * USSW2 = 1 /
		VAXIS=AXIS1 VMINOR=0 HAXIS=AXIS3 HMINOR=0
		DESCRIPTION = "Observed FNCL by USSW2"
	;
	RUN;

	TITLE4 "Observed FNCL by USSW5";
	SYMBOL1 C=BLUE V=DOT HEIGHT=2PCT INTERPOL=RL L=1 W=1;
	WHERE FNCL IS NOT MISSING AND USSW5 IS NOT MISSING;
	PLOT FNCL * USSW5 = 1 /
		VAXIS=AXIS1 VMINOR=0 HAXIS=AXIS3 HMINOR=0
		DESCRIPTION = "Observed FNCL by USSW5"
	;
	RUN;

	TITLE4 "Observed FNCL by USSW10";
	SYMBOL1 C=BLUE V=DOT HEIGHT=2PCT INTERPOL=RL L=1 W=1;
	WHERE FNCL IS NOT MISSING AND USSW10 IS NOT MISSING;
	PLOT FNCL * USSW10 = 1 /
		VAXIS=AXIS1 VMINOR=0 HAXIS=AXIS3 HMINOR=0
		DESCRIPTION = "Observed FNCL by USSW10"
	;
	RUN;
